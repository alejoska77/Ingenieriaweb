			...
			<tbody>
				<?php
				  ...
				  $result2=mysqli_query($conexion,'SELECT nombre FROM usuarios where tipo="estado"');
					...
					echo"<td id='id:$id''><select id='id".$estad."' name='$id2'>";					 
...
<!--//////////////////////////////////////////////////////////////////////////////////////////////////-->
    <script type="text/javascript">
		<?php
		$result1=mysqli_query($conexion,'SELECT nombre FROM usuarios where tipo="estado"');
	    while ($esta=mysqli_fetch_array($result1)){
			?>
